...
#Matching com tratamento de abertura de escolas pelo incumbente em cada Legislatura:
  ...
  var<-c("NR_ANO","NR_ZONA","NR_LOCVOT","QTD_VOTOS_P","QTD_VOTOS_P_lag","rend","i0_9","i10_19",paste(c("I_esc_ini_fun_","esc_ini_fun_lag_","esc_nao_fun_lag_"),n_dist,sep = ""))
  ...
  lv_match04_1<-matchit(I_esc_ini_fun_1Km ~ QTD_VOTOS_P_lag + esc_ini_fun_lag_1Km + esc_nao_fun_lag_1Km + rend + i0_9 + i10_19,
  ...
  lv_match08_1<-matchit(I_esc_ini_fun_1Km ~ QTD_VOTOS_P_lag + esc_ini_fun_lag_1Km + esc_nao_fun_lag_1Km + rend + i0_9 + i10_19,
                      data = temp1[!is.na(temp1$QTD_VOTOS_P_lag)&temp1$NR_ANO==2008,],
                      method = "nearest", distance = "logit",discard = "control", m.order="largest", replace=T)
  
  #2012 e 2016:
  
  lv_match12_1<-matchit(I_esc_ini_fun_1Km ~ QTD_VOTOS_P_lag + esc_ini_fun_lag_1Km + esc_nao_fun_lag_1Km + rend + i0_9 + i10_19,
                   data = temp2[!is.na(temp2$QTD_VOTOS_P_lag)&temp2$NR_ANO==2012,],
                   method = "nearest", distance = "logit",discard = "control", m.order="largest", replace=T)
  
  lv_match16_1<-matchit(I_esc_ini_fun_1Km ~ QTD_VOTOS_P_lag + esc_ini_fun_lag_1Km + esc_nao_fun_lag_1Km + rend + i0_9 + i10_19,
...
#Matching com tratamento de abertura de escolas criadas pelo incumbente em cada legislatura:
  ...
  var<-c("NR_ANO","NR_ZONA","NR_LOCVOT","QTD_VOTOS_P","QTD_VOTOS_P_lag","rend","i0_9","i10_19",paste(c("I_esc_ini_fun_incumb_","esc_ini_fun_lag_","esc_nao_fun_lag_"),n_dist,sep = ""))
  ...
  lv_match04_2<-matchit(I_esc_ini_fun_incumb_1Km ~ QTD_VOTOS_P_lag + esc_ini_fun_lag_1Km + esc_nao_fun_lag_1Km + rend + i0_9 + i10_19,
                      data = temp1[!is.na(temp1$QTD_VOTOS_P_lag)&temp1$NR_ANO==2004,],
                      method = "nearest", distance = "logit",discard = "control", m.order="largest", replace=T)
  
  lv_match08_2<-matchit(I_esc_ini_fun_incumb_1Km ~ QTD_VOTOS_P_lag + esc_ini_fun_lag_1Km + esc_nao_fun_lag_1Km + rend + i0_9 + i10_19,
                      data = temp1[!is.na(temp1$QTD_VOTOS_P_lag)&temp1$NR_ANO==2008,],
                      method = "nearest", distance = "logit",discard = "control", m.order="largest", replace=T)
  
  #2012 e 2016:
  
  lv_match12_2<-matchit(I_esc_ini_fun_incumb_1Km ~ QTD_VOTOS_P_lag + esc_ini_fun_lag_1Km + esc_nao_fun_lag_1Km + rend + i0_9 + i10_19,
                      data = temp2[!is.na(temp2$QTD_VOTOS_P_lag)&temp2$NR_ANO==2012,],
                      method = "nearest", distance = "logit",discard = "control", m.order="largest", replace=T)
  
  lv_match16_2<-matchit(I_esc_ini_fun_incumb_1Km ~ QTD_VOTOS_P_lag + esc_ini_fun_lag_1Km + esc_nao_fun_lag_1Km + rend + i0_9 + i10_19,
                      data = temp2[!is.na(temp2$QTD_VOTOS_P_lag)&temp2$NR_ANO==2016,],
                      method = "nearest", distance = "logit",discard = "control", m.order="largest", replace=T)
...
#Matching com tratamento de abertura de escolas no ano da eleição em cada legislatura:
  ...
  var<-c("NR_ANO","NR_ZONA","NR_LOCVOT","QTD_VOTOS_P","QTD_VOTOS_P_lag","rend","i0_9","i10_19",paste(c("I_esc_ini_fun_a4_","esc_ini_fun_lag_","esc_nao_fun_lag_"),n_dist,sep = ""))
  ...
  lv_match04_3<-matchit(I_esc_ini_fun_a4_1Km ~ QTD_VOTOS_P_lag + esc_ini_fun_lag_1Km + esc_nao_fun_lag_1Km + rend + i0_9 + i10_19,
                        data = temp1[!is.na(temp1$QTD_VOTOS_P_lag)&temp1$NR_ANO==2004,],
                        method = "nearest", distance = "logit",discard = "control", m.order="largest", replace=T)
  
  lv_match08_3<-matchit(I_esc_ini_fun_a4_1Km ~ QTD_VOTOS_P_lag + esc_ini_fun_lag_1Km + esc_nao_fun_lag_1Km + rend + i0_9 + i10_19,
                        data = temp1[!is.na(temp1$QTD_VOTOS_P_lag)&temp1$NR_ANO==2008,],
                        method = "nearest", distance = "logit",discard = "control", m.order="largest", replace=T)
  
  #2012 e 2016:
  
  lv_match12_3<-matchit(I_esc_ini_fun_a4_1Km ~ QTD_VOTOS_P_lag + esc_ini_fun_lag_1Km + esc_nao_fun_lag_1Km + rend + i0_9 + i10_19,
                        data = temp2[!is.na(temp2$QTD_VOTOS_P_lag)&temp2$NR_ANO==2012,],
                        method = "nearest", distance = "logit",discard = "control", m.order="largest", replace=T)
  
  lv_match16_3<-matchit(I_esc_ini_fun_a4_1Km ~ QTD_VOTOS_P_lag + esc_ini_fun_lag_1Km + esc_nao_fun_lag_1Km + rend + i0_9 + i10_19,
                        data = temp2[!is.na(temp2$QTD_VOTOS_P_lag)&temp2$NR_ANO==2016,],
                        method = "nearest", distance = "logit",discard = "control", m.order="largest", replace=T)
